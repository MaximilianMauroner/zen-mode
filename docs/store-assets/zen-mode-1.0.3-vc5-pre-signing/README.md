...
reviewer video. The binary recordings are deliberately not retained in Git;
the following hashes preserve the reviewed test provenance:
...
- `reviewer-02-lock-and-failed-clock-attempt.mp4` (173.352 s, 1080 x 2400,
  ...
  timed-visit overlay, so this was a failed attempt and must
